...
public class StreamUtil {
  ...
  public static InputStream getResource(ClassLoader classLoader, final String path)
      throws IOException {
  ...
  public static String getTextResource(ClassLoader classLoader, final String path)
      throws IOException {
