...
public final class TestKindMeta
    extends org.slim3.datastore.ModelMeta<net.vvakame.memvache.test.TestKind> {

  /** */
  public final org.slim3.datastore.CoreUnindexedAttributeMeta<
          net.vvakame.memvache.test.TestKind, byte[]>
      data =
          new org.slim3.datastore.CoreUnindexedAttributeMeta<
              net.vvakame.memvache.test.TestKind, byte[]>(this, "data", "data", byte[].class);

  /** */
  public final org.slim3.datastore.CoreAttributeMeta<
          net.vvakame.memvache.test.TestKind, com.google.appengine.api.datastore.Key>
      key =
          new org.slim3.datastore.CoreAttributeMeta<
              net.vvakame.memvache.test.TestKind, com.google.appengine.api.datastore.Key>(
  ...
  public final org.slim3.datastore.StringAttributeMeta<net.vvakame.memvache.test.TestKind> keyStr =
      new org.slim3.datastore.StringAttributeMeta<net.vvakame.memvache.test.TestKind>(
          this, "keyStr", "keyStr");
  ...
  /** */
  public final org.slim3.datastore.StringCollectionAttributeMeta<
          net.vvakame.memvache.test.TestKind, java.util.List<java.lang.String>>
      strList =
          new org.slim3.datastore.StringCollectionAttributeMeta<
              net.vvakame.memvache.test.TestKind, java.util.List<java.lang.String>>(
  ...
  public net.vvakame.memvache.test.TestKind entityToModel(
    ...
    model.setData(
        blobToBytes((com.google.appengine.api.datastore.Blob) entity.getProperty("data")));
  ...
  protected net.vvakame.memvache.test.TestKind jsonToModel(
    ...
    if (m.getData() != null) {
      m.setData(
          decoder0
              .decode(reader, new com.google.appengine.api.datastore.ShortBlob(m.getData()))
              .getBytes());
    } else {
